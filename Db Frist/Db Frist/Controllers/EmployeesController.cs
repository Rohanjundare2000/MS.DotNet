...
namespace Db_Frist.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            ViewData["DeptNo"] = new SelectList(_context.Departments, "DeptName", "DeptNo");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("EmpNo,Name,Basic,DeptNo")] Employee employee)
        {
            if (ModelState.IsValid)
            {
               ...
               // _context.Add(employee);
                await _context.SaveChangesAsync();// changes in database and itis batch update
                return RedirectToAction(nameof(Index));
            }
            ViewData["DeptNo"] = new SelectList(_context.Departments, "DeptName", "DeptNo", employee.DeptNo);
            return View(employee);
        }
